...
namespace Lidgren.Network
{
	public partial class NetPeer
	{
		...
		/// <summary>
		/// This method is called from the NetRecieverChannels when a message is handled.
		/// This method enqueues the message to be handled on the seperate thread.
		/// </summary>
		/// <param name="msg">Netincoming message</param>
